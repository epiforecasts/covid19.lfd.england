...
Updated on: `r lubridate::today()`. Periods during which schools were closed are shaded dark.

```{r lfd_tesing, echo = FALSE}
suppressWarnings(suppressMessages(source(here::here("inst", "scripts", "lfd.r"))))
```
